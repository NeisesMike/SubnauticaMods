...
namespace PersistentReaper
{
    ...
    public class ReaperUpdatePatcher
    {
        ...
        public static void Postfix(ReaperLeviathan __instance)
        {
            ...
            if (MainPatcher.PRConfig.reaperBehaviors != ReaperBehaviors.Normal)
            {
            ...
            // HumanHunter.Update
            if (MainPatcher.PRConfig.reaperBehaviors == ReaperBehaviors.HumanHunter && lastUpdateTime + updateInterval < Time.time)
            {
